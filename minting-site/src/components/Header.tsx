        ...
        }
        {
          ...
          <div>
            <button className="btn btn-ghost btn-square btn-s text-accent">
              <a href="https://github.com/SuipStakes/contracts" target="_blank" rel="noopener noreferrer">
            ...
            <button className="btn btn-ghost btn-square btn-s text-accent">
              <a href="https://discord.gg/n84KrQgpYJ" target="_blank" rel="noopener noreferrer">
            ...
            <button className="btn btn-ghost btn-square btn-s text-accent">
              <a href="https://twitter.com/SuipStakes" target="_blank" rel="noopener noreferrer">
